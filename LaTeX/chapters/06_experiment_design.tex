...
\begin{itemize}
    ...
    \item \textbf{Expectation of a sum}: $E[X + Y] = E[X] + E[Y]$
    \item \textbf{Unconscious Statistician}: $E[g(X)] = \sum_{x \in S} g(x) P(X=x)$, where $g$ is a function of the random variable $X$.
\end{itemize}
